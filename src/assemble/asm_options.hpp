...
struct AsmOptions {
    ...
    std::string reduction0 {"transitive:fuzz=500|quality|spur|best:debug|spur|phase|unreliable:debug|spur|bridge|"};
    std::string reduction1 {"spur|duplicate|cross|bridge|bubble:s=1|bridge|bubble:s=0|spur|loop|semi:debug"};
